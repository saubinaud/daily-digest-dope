    ...
    extend: {
      ...
      colors: {
        ...
        news: {
          ...
          "accent-light": "hsl(var(--news-accent-light))",
        },
        glass: {
          border: "hsl(var(--glass-border))",
        },
        favorite: {
          star: "hsl(var(--favorite-star))",
        },
        category: {
          ia: "hsl(var(--category-ia))",
          marketing: "hsl(var(--category-marketing))",
          bolsa: "hsl(var(--category-bolsa))",
      ...
      keyframes: {
        ...
        "glow": {
          ...
          "50%": { textShadow: "0 0 30px rgba(99, 102, 241, 0.8)" }
        }
      },
      animation: {
